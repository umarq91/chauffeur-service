...
const ContactSection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.sendForm('service_rjt1y07', 'template_axw0oba',{
        message: 'some message',
    } ,e.target, 'Lk3rT6NGL9L5D4x1X')
      .then((result) => {
              ...
              <ul className="mb-6 md:mb-0">
                ...
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600 dark:text-slate-400">Mobile: {contactInfo.phone}</p>
                    <p className="text-gray-600 dark:text-slate-400">Mail: {contactInfo.email}</p>
                  </div>
                </li>
                <li className="flex">
                  <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
